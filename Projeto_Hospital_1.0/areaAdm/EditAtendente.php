...
$id = $_GET['id'];
$sql = "SELECT * FROM atendente WHERE aten_id = '$id'";
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "UPDATE atendente SET aten_nome='$nome', aten_senha='$senha', aten_cpf='$cpf', aten_email='$email', aten_horainicio='$horainicio', aten_horafim='$horafim', aten_datanasc='$datanasc', aten_telefone='$telefone', aten_cidade='$cidade', aten_endereco='$endereco', aten_numero='$numero', aten_ativo='$ativo' WHERE aten_id= $id";
    mysqli_query($link, $sql);

    echo"<script>window.alert('ATENDENTE ALTERADO COM SUCESSO!');</script>";
    echo"<script>window.location.href='listaAtendente.php';</script>";
}
...
<div class="form_box">
        <form action="EditAtendente.php" method="post" onsubmit="removerFormatacaoCPF()">
            <fieldset>
        ...
        <div class="container_btn_voltar">
            <a href="listaAtendente.php"><button class="btn_voltar">Voltar</button></a>
        </div>
