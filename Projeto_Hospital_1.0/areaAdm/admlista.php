...
<div class="container-contrata">
 <div class="card-container">
    ...
    <a href="listaAtendente.php">
    <div class="box-contratar" style="--clr:#fc5f64;">
        <div class="content-contratar">
            <div class="icon-contratar"><i class="fa-solid fa-clipboard-list"></i></i></div>
            <div class="text-contratar">
                <h3>Atendentes</h3>
                <p>veja a Lista de Atendentes</p>
            </div>     
        </div>
    </div>
    </a>
