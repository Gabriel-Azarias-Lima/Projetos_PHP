...
// COLETA DE DADOS DE CLIENTES NA SESSÃO
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $numerocarrinho = MD5($_SESSION['idcliente'].date('d-m-Y H:i-s'));  // CRIANDO UM CODIGO ALEATORIO DE FORMA QUE NÃO É REPETIDO PARA NIMGUEM
    ...
    if($idcliente <= 0){
        ...
        while($tbl = mysqli_fetch_array($retorno)){
            ...
            if($cont == 0){
                ...
                // SE O CARRINHO EXISTE, CONSULTA NUMERO CARRINHO PAR ADD ITENS AO CARRINHO
...
<header>
    ...
    <div class="formulario">
        <form class="visualizaproduto" action="verproduto.php" method="post" enctype="multipart/form-data">
            ...
            <label>NOME</label>
            <input type="text" name="nomeproduto" id="nome" value="<?= $nomeproduto ?>">

            <label>DESCRIÇÃO</label>
            <textarea name="descricao" readonly></textarea> <!-- posibilita a visualização do texto, readonly inpede de alterar -->
